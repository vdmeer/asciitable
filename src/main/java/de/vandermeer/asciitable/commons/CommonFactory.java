...
public abstract class CommonFactory {
	 ...
	 * @return new pair
	 */
	public static <LHS, RHS> TablePair<LHS, RHS> createTablePair(LHS lhs, RHS rhs){
		return CommonFactory.createTablePair(lhs, rhs, "abstract IsPath implementation");
	}
	 ...
	 * @return new pair
	 */
	public static <LHS, RHS> TablePair<LHS, RHS> createTablePair(final LHS lhs, final RHS rhs, final String description){
