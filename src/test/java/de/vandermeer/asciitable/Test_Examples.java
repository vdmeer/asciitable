...
public class Test_Examples implements StandardExampleRunner {
	...
	@Test
	public void test_00a_Simple_Table(){
		this.runExample(new AT_00a_Simple_Table());
	}
	...
	@Test
	public void test_03a_AlignmentBehavior(){
		this.runExample(new AT_03a_AlignmentOptions());
	}

	@Test
	public void test_03b_AlignmentTable(){
		this.runExample(new AT_03b_AlignmentTable());
	}

	@Test
	public void test_03c_AlignmentRow(){
		this.runExample(new AT_03c_AlignmentRow());
	}

	@Test
	public void test_03d_AlignmentCell(){
		this.runExample(new AT_03d_AlignmentCell());
	}
